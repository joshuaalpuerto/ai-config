---
name: doc-audit
description: Surface contributor-enablement gaps in ai-config — missing or stale docs and undocumented conventions that would prevent a new joiner (human or AI) from producing convention-adherent contributions immediately.
allowed-tools:
  - Bash
  - Read
  - Agent
...
aicfg analyze /workspaces/ai-config --kind=doc
```
